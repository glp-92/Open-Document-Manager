...
export function ChatArea({ messages, onSend, workspaceName, hasDocuments }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 bg-background">
      ...
      <div className="h-14 border-b border-border flex items-center px-6">
        <h1 className="text-sm font-semibold text-foreground truncate">{workspaceName}</h1>
      </div>
      ...
      <div className="border-t border-border p-4">
        <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
          <div className="flex items-center gap-2 bg-secondary rounded-xl px-4 py-2 focus-within:ring-2 focus-within:ring-ring/20 transition-shadow">
            <input
              value={input}

...
class ChatService:
    ...
    async def create_chat(self, session: Session, new_chat_request: NewChatRequest) -> ChatResponse:
    ...
    async def find_chats_with_filters_pageable(self, session: Session, filters: ChatFilters) -> ChatListResponse:
    ...
    async def delete_chat_by_id(self, session: Session, chat_id: UUID):

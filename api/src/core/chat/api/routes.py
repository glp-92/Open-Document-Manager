...
class ChatRouter:
    ...
    def _register_routes(self):
        ...
        async def delete_chat(chat_id: UUID, uow: SqlAlchemyUnitOfWork = Depends(get_db)):
            try:
                return self.chat_service.delete_chat_by_id(session=uow.session, chat_id=chat_id)
